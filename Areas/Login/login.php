            ...
            <div class="container">
                <div class="navbar flex-sm-row-reverse"  style="margin:0; padding: 0px;">
                    ...
                    <ul class="navbar-nav flex-row  mr-auto">
                        ...
                        <li class="nav-item ">
                            <button class="btn btn-primary btn-lg" type="button" style="color: #306ebb; background-color: #ffffff;" onclick="location.href='../Registro/registro.php'">Registrarse</button>
                        </li>
                        <li class="nav-item ">
                            <p style="color: #306ebb;">|</p> <!-- Separador improvisado jeje -->
                        </li>
                        <li class="nav-item">
                            <button class="btn btn-primary btn-lg" type="button" style="margin: qpx; POSITION: absolute; color: #306ebb; background-color: #ffffff;">Iniciar Sesión</button>
                        </li>
                    </ul>
            ...
            <section id="main" class="wrapper">
                ...
                <br><br>
                    <form action="validarUsuario.php" method="post">
                            <img src="../../img/man.1.png" alt="" width="30px" height="30px" style="margin-top:-10px">
                            <label>Usuario</label>
                            <input type="text" name="usuario" placeholder="Captura tu usuario" required>
                            <br>
                            <img src="../../img/lock.1.png" alt="" width="30px" height="30px" style="margin-top:-10px">
                ...
                <br><br>
                <div class="container">
                        <a href="../Registro/registro.php">Obtener cuenta</a><br>
                        <span><A href="../../recuperar.php">¿Olvido su Contraseña?</A></span>
                </div>
	        </section>
